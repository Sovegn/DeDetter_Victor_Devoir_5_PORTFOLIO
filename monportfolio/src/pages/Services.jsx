...
const Services = () => {
  const servicesData = [
    {
      icon: <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="#007bff" class="bi bi-brush" viewBox="0 0 16 16">
    ...
    {
      icon: <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="#007bff" class="bi bi-code-slash" viewBox="0 0 16 16">
    ...
    {
      icon: <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="#007bff" class="bi bi-search" viewBox="0 0 16 16">
  ...
  return (
    <div className="services-container">
      ...
      <div className="services-content">
        <strong>Mon offre de services</strong>
        <p className="services-subtitle">Voici les prestations sur lesquelles je peux intervenir</p>
