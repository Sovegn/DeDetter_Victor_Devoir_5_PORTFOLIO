...
/**
 * Services est une page qui répertorie les services que je peux offrir
 * en tant que développeur web. La page est divisée en 3 parties :
 * - Une bannière qui affiche mon nom et mon prénom
 * - Une section qui affiche les services que je peux offrir
 *   (UX Design, Développement web et Référencement)
 * - Une section qui affiche les détails de chaque service
 *   (une icône, un titre et une description)
 */

const Services = () => {
  /**
   * MockData des services que je peux offrir.
   */
  const servicesData = [
    {
      icon: (
